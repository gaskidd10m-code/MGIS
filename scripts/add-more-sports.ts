...
<p>This award recognizes Raphinha's contribution to Barcelona's success and his standing among La Liga's elite players. His performances have drawn praise from coaches, teammates, and opponents alike.</p>`,
        ...
        },
        {
            ...
            content: `<p>Ruben Neves' future at Al Hilal remains uncertain as the Portuguese midfielder has yet to sign a new contract despite a proposal being on the table for weeks. With his current deal expiring in June 2026, several European top clubs have started making approaches.</p>
